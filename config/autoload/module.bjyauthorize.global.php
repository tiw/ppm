        ...
        'guards' => array(
           /* If this guard is specified here (i.e. it is enabled), it will block
            ...
            'BjyAuthorize\Guard\Route' => array(
                ...
                array('route' => 'product-decoration', 'roles' => array('guest', 'user')),
                array('route' => 'product-utensil', 'roles' => array('guest', 'user')),
                array('route' => 'product-vintage', 'roles' => array('guest', 'user')),
                array('route' => 'product-omament', 'roles' => array('guest', 'user')),
